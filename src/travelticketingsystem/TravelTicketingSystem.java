...
//PAYMENTS
                receipt(new payment.payment(payment.getPayment_date(),playground_ticket.getTicket_name(),payment.total_amount(playground_ticket.total_ticket_price())));
                continueInput = false;
                } 
                 break;
            ...
            case 2:
                ...
                first2:{
                 ...
                 //PAYMENT
                receipt(new payment.payment(payment.getPayment_date(),water_travel.getTicket_name(),payment.total_amount(water_travel.total_ticket_price())));
                continueInput = false;
                }             
                break;
            case 3:
